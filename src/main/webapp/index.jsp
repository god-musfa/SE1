...
<head>
    ...
    <script src="https://kaul.inf.h-brs.de/ccmjs/mkaul-components/parkhaus/versions/ccm.parkhaus-11.4.1.js"></script>
...
<div class="box lightyellow">
    ...
    <ccm-parkhaus-11-4-1 server_url="./level1-servlet"
                         debug="true"
                         name="Etage1"
                         license_max="15"
...
<div class="box lightgreen">
    ...
    <ccm-parkhaus-11-4-1 server_url="./level2-servlet"
                         name="Etage2"
                         license_min="16"
                         license_max="30"
                         extra_buttons='["reset"]'
